...
// Checkin $Date: February 24, 2009   14:22:38 $
//###########################################################################
//
...
#if (G37PL != 0)
interrupt void EPWM7_INT_ISR(void)     // ePWM4 Interrupt
{
	// Set interrupt priority:
	volatile Uint16 TempPIEIER = PieCtrlRegs.PIEIER3.all;
	IER |= M_INT3;
...
#if (G127PL != 0)
interrupt void LVF_ISR(void)     // CLA1
{
	// Set interrupt priority:
	volatile Uint16 TempPIEIER = PieCtrlRegs.PIEIER12.all;
	IER |= M_INT12;
...
#if (G128PL != 0)
interrupt void LUF_ISR(void)     // CLA1
{
	// Set interrupt priority:
	volatile Uint16 TempPIEIER = PieCtrlRegs.PIEIER12.all;
	IER |= M_INT12;
