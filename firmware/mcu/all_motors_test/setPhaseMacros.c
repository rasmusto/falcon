...
#define SET_PHASE_STATE_5_MOT1() \
	...
	phaseOutputsELow |= 0b00100000; \
									\
	PORTF.OUTCLR = 0b00001111; /* set b1 and a1 floating -- important to do this in this order to avoid shoot through!! */ \
	PORTF.OUTSET = 0b00001000; /* set b1 low */ \

// Motor 2

#define SET_PHASE_STATE_0_MOT2() \
	phaseOutputsEHigh &= 0b01111111; \
	phaseOutputsEHigh |= 0b01000000;  /* set bits 6-7 of phaseOutputsEHigh to 01 */ \
									\
	phaseOutputsELow &= 0b10111111; \
...
#define SET_PHASE_STATE_1_MOT2() \
	phaseOutputsEHigh &= 0b01111111; \
	phaseOutputsEHigh |= 0b01000000; \
									\
	phaseOutputsELow &= 0b10111111; \
	phaseOutputsELow |= 0b10000000; \
									\
...
#define SET_PHASE_STATE_2_MOT2() \
	...
	phaseOutputsELow &= 0b00111111; \
									\
	phaseOutputsFHigh &= 0b11110001; \
	phaseOutputsFHigh |= 0b00000001; \
									\
	phaseOutputsFLow &= 0b11110010; \
...
#define SET_PHASE_STATE_4_MOT2() \
	...
	phaseOutputsELow &= 0b00111111; \
									\
	phaseOutputsFHigh &= 0b11110100; \
	phaseOutputsFHigh |= 0b00000100; \
									\
	phaseOutputsFLow &= 0b11111000; \
...
#define SET_PHASE_STATE_0_MOT3() \
	...
	phaseOutputsFLow |= 0b00100000; \
									\
	phaseOutputsDHigh &= 0b00111111; \
	phaseOutputsDLow &= 0b00111111; \
									\
...
#define SET_PHASE_STATE_4_MOT3() \
	...
	phaseOutputsDHigh |= 0b00000001; \
									\
	phaseOutputsDLow &= 0b11000011; \
	phaseOutputsDLow |= 0b00000010; \
									 \
	phaseOutputsFHigh &= 0b00001111; \
	phaseOutputsFLow &= 0b00001111;  \
									\
	PORTE.OUTCLR = 0b11110000; /* set a3 and b3 floating -- important to do this in this order to avoid shoot through!! */ 	\
	PORTE.OUTSET = 0b00100000; /* set a3 low */
...
#define SET_PHASE_STATE_5_MOT3() \
	...
	phaseOutputsFLow &= 0b00001111;  \
									\
	PORTE.OUTCLR = 0b11110000; /* set a3 and b1 floating -- important to do this in this order to avoid shoot through!! */ 	\
	PORTE.OUTSET = 0b10000000; /* set b3 low */
...
#define SET_PHASE_STATE_2_MOT4()     \
	...
	phaseOutputsDLow |= 0b00100000;  \
									 \
	PORTD.OUTCLR = 0b00110011; /* set a3 and c3 floating -- important to do this in this order to avoid shoot through!! */ \
...
#define SET_PHASE_STATE_4_MOT4() \
	...
	phaseOutputsDLow |= 0b10000010; \
									 \
	PORTD.OUTCLR = 0b11110000; /* set a3 and b3 floating -- important to do this in this order to avoid shoot through!! */ 	\
	PORTD.OUTSET = 0b00100000; /* set a3 low */
...
#define SET_PHASE_STATE_5_MOT4() \
	...
	phaseOutputsDLow |= 0b10000000; \
									\
	PORTD.OUTCLR = 0b11000011; /* set a4 and b4 floating -- important to do this in this order to avoid shoot through!! */ 	\
	PORTD.OUTSET = 0b00100000; /* set b4 low */
