...
;                    
; Description   : 4 channel Data logging macro with Trigger input
...
;----------------------------------------------------------------------------------
; 02/01/02	| DAF		| Original		New Release (DAF)
;----------------------------------------------------------------------------------
;----------------------------------------------------------------------------------
; 03/31/08	| HRN		| ACDC Internal release (Minor Changes to the DLOG update 
;						|  function to work as a macro)	
;----------------------------------------------------------------------------------
