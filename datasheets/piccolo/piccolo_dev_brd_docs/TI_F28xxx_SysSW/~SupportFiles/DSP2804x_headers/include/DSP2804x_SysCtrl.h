...
// Checkin $Date: July 2, 2007   09:47:51 $
//###########################################################################
//
// FILE:   DSP2804x_SysCtrl.h
//
// TITLE:  DSP2804x Device System Control Register Definitions.
//
//###########################################################################
...
#ifndef DSP2804x_SYS_CTRL_H
#define DSP2804x_SYS_CTRL_H
...
struct PCLKCR2_BITS  {    // bits  description
   ...
   Uint16 EPWM10ENCLK:1;  // 1     Enable SYSCLKOUT to EPWM10
   Uint16 EPWM11ENCLK:1;  // 2     Enable SYSCLKOUT to EPWM11
   Uint16 EPWM12ENCLK:1;  // 3     Enable SYSCLKOUT to EPWM12
   Uint16 EPWM13ENCLK:1;  // 4     Enable SYSCLKOUT to EPWM13
   Uint16 EPWM14ENCLK:1;  // 5     Enable SYSCLKOUT to EPWM14
   Uint16 EPWM15ENCLK:1;  // 6     Enable SYSCLKOUT to EPWM15
   Uint16 EPWM16ENCLK:1;  // 7     Enable SYSCLKOUT to EPWM16
...
#endif  // end of DSP2804x_SYS_CTRL_H definition
