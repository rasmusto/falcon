...
// Checkin $Date: July 17, 2006   16:25:36 $
//###########################################################################
//
// FILE:   DSP2804x_Gpio.h
//
// TITLE:  DSP2804x General Purpose I/O Definitions.
//
//###########################################################################
...
#ifndef DSP2804x_GPIO_H
#define DSP2804x_GPIO_H
...
struct GPAMCFG_BITS {         // bits   description  
   Uint16 EPWMMODE:2;         // 1:0    Select how ePWM1-16 are mapped to GPIO A pins
   Uint16 rsvd:14;
   Uint16 rsvd2:16;            
};      
...
struct GPIO_CTRL_REGS {
   ...
   union  GPAMCFG_REG      GPAMCFG;      // ePWM GPIO Configuration Register
...
#endif  // end of DSP2804x_GPIO_H definition
