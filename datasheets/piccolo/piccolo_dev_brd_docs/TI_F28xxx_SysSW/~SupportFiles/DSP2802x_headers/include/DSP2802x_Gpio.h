...
// Checkin $Date: August 14, 2008   16:55:44 $
//###########################################################################
//
...
struct AIO_BITS {            // bits   description
   Uint16 AIO0:2;            // 1:0    GPIO0
   Uint16 AIO1:2;            // 3:2    GPIO1
   Uint16 AIO2:2;            // 5:4    GPIO2
   Uint16 AIO3:2;            // 7:6    GPIO3
   Uint16 AIO4:2;            // 9:8    GPIO4
   Uint16 AIO5:2;            // 11:10  GPIO5
   Uint16 AIO6:2;            // 13:12  GPIO6
   Uint16 AIO7:2;            // 15:14  GPIO7
   Uint16 AIO8:2;            // 17:16  GPIO8
   Uint16 AIO9:2;            // 19:18  GPIO9
   Uint16 AIO10:2;           // 21:20  GPIO10
   Uint16 AIO11:2;           // 23:22  GPIO11
   Uint16 AIO12:2;           // 25:24  GPIO12
   Uint16 AIO13:2;           // 27:26  GPIO13
   Uint16 AIO14:2;           // 29:28  GPIO14
   Uint16 AIO15:2;           // 31:30  GPIO15
};
...
struct XCLKINSEL_BITS {       // bits   description
	Uint16 GPIOSEL:5;         // 4:0    XCLKIN GPIO Input Select Bits
	Uint16 rsvd1:11;          // 15:5   reserved
};

union XCLKINSEL_REG {
	Uint16                all;
	struct XCLKINSEL_BITS bit;
};
...
struct GPIO_INT_REGS {
   ...
   union  XCLKINSEL_REG    XCLKINSEL;    // XCLKIN GPIO Input Selection
};
