...
//	Version: 		1.2
//
//  Target:  		TMS320F280x, TMS320F2802x(PiccoloA),TMS320F2804x, 
//					or TMS320F2833x families
//
...
//  Put peripheral initialisation here
	...
	// PWM initialisation
	// prd = 250 => Period count = 400 KHz @ 100 MHz
	//BuckSingle_CNF(1, 250, 1, 0);	// ePWM1, Period=prd, Master, Phase=Don't Care
...
{	
	...
	{ 
		...
		GpioDataRegs.GPBTOGGLE.bit.GPIO34 = 1;   // for dim 168
