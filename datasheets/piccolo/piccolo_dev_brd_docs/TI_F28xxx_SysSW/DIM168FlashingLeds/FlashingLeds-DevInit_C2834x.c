...
//
// TITLE:	Device initialization for C2834x series
// 
// Version: 05 Mar 08
//============================================================================
//============================================================================
...
//  GPIO-40 - PIN FUNCTION = --Spare--
	GpioCtrlRegs.GPBMUX1.bit.GPIO40 = 0;	// 0=GPIO,  1=Resv,  2=XA0,  3=Resv
...
//  GPIO-41 - PIN FUNCTION = --Spare--
	GpioCtrlRegs.GPBMUX1.bit.GPIO41 = 0;	// 0=GPIO,  1=Resv,  2=XA1,  3=Resv
...
//  GPIO-42 - PIN FUNCTION = --Spare--
	GpioCtrlRegs.GPBMUX1.bit.GPIO42 = 0;	// 0=GPIO,  1=Resv,  2=XA2,  3=Resv
...
//  GPIO-43 - PIN FUNCTION = --Spare--
	GpioCtrlRegs.GPBMUX1.bit.GPIO43 = 0;	// 0=GPIO,  1=Resv,  2=XA3,  3=Resv
...
//  GPIO-44 - PIN FUNCTION = --Spare--
	GpioCtrlRegs.GPBMUX1.bit.GPIO44 = 0;	// 0=GPIO,  1=Resv,  2=XA4,  3=Resv
...
//  GPIO-45 - PIN FUNCTION = --Spare--
	GpioCtrlRegs.GPBMUX1.bit.GPIO45 = 0;	// 0=GPIO,  1=Resv,  2=XA5,  3=Resv
...
//  GPIO-46 - PIN FUNCTION = --Spare--
	GpioCtrlRegs.GPBMUX1.bit.GPIO46 = 0;	// 0=GPIO,  1=Resv,  2=XA6,  3=Resv
	GpioCtrlRegs.GPBDIR.bit.GPIO46 = 0;		// 1=OUTput,  0=INput 
...
//  GPIO-47 - PIN FUNCTION = --Spare--
	GpioCtrlRegs.GPBMUX1.bit.GPIO47 = 0;	// 0=GPIO,  1=Resv,  2=XA7,  3=Resv
...
//  GPIO-50 - PIN FUNCTION = --Spare--
	GpioCtrlRegs.GPBMUX2.bit.GPIO50 = 0;	// 0=GPIO,  1=EQEP1-A,  2=XD31,  3=SPICLKD
...
//  GPIO-51 - PIN FUNCTION = --Spare--
	GpioCtrlRegs.GPBMUX2.bit.GPIO51 = 0;	// 0=GPIO,  1=EQEP1-B,  2=XD28,  3=SPISTED
...
//  GPIO-52 - PIN FUNCTION = --Spare--
	GpioCtrlRegs.GPBMUX2.bit.GPIO52 = 0;	// 0=GPIO,  1=EQEP1S,  2=XD27,  3=Resv
...
//  GPIO-53 - PIN FUNCTION = --Spare--
	GpioCtrlRegs.GPBMUX2.bit.GPIO53 = 0;	// 0=GPIO,  1=EQEP1I,  2=XD26,  3=Resv
...
//  GPIO-70 - PIN FUNCTION = --Spare--
	...
	GpioCtrlRegs.GPCDIR.bit.GPIO70 = 0;		// 1=OUTput,  0=INput 
...
//  GPIO-71 - PIN FUNCTION = --Spare--
	...
	GpioCtrlRegs.GPCDIR.bit.GPIO71 = 0;		// 1=OUTput,  0=INput 
...
//  GPIO-76 - PIN FUNCTION = --Spare--
	...
	GpioCtrlRegs.GPCDIR.bit.GPIO76 = 0;		// 1=OUTput,  0=INput 
...
//  GPIO-78 - PIN FUNCTION = --Spare--
	...
	GpioCtrlRegs.GPCDIR.bit.GPIO78 = 0;		// 1=OUTput,  0=INput 
...
//  GPIO-79 - PIN FUNCTION = --Spare--
	...
	GpioCtrlRegs.GPCDIR.bit.GPIO79 = 0;		// 1=OUTput,  0=INput 
...
//  GPIO-80 - PIN FUNCTION = --Spare--
	...
	GpioCtrlRegs.GPCDIR.bit.GPIO80 = 0;		// 1=OUTput,  0=INput 
...
//  GPIO-82 - PIN FUNCTION = --Spare--
	...
	GpioCtrlRegs.GPCDIR.bit.GPIO82 = 0;		// 1=OUTput,  0=INput 
...
//  GPIO-83 - PIN FUNCTION = --Spare--
	...
	GpioCtrlRegs.GPCDIR.bit.GPIO83 = 0;		// 1=OUTput,  0=INput 
...
//      SysCtrlRegs.PLLSTS.bit.MCLKOFF = 0;
      ...
      // Then switch to 1/2
	  // Doing it this way slows inrush current
