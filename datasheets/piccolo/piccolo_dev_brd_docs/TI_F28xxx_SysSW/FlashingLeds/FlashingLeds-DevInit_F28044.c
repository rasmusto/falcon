...
//============================================================================
//
// FILE:	FlashingLeds-DevInit_F2804x.c
//
// TITLE:	Device initialization for F2804x series
// 
// Version: 13 Aug 06 - R0
//============================================================================
//============================================================================
...
// Refer to the datasheet for your particular device. 
   ...
   SysCtrlRegs.PCLKCR2.bit.EPWM9ENCLK = 0;   // ePWM9
   SysCtrlRegs.PCLKCR2.bit.EPWM10ENCLK = 0;  // ePWM10
   SysCtrlRegs.PCLKCR2.bit.EPWM11ENCLK = 0;  // ePWM11
   SysCtrlRegs.PCLKCR2.bit.EPWM12ENCLK = 0;  // ePWM12
   SysCtrlRegs.PCLKCR2.bit.EPWM13ENCLK = 0;  // ePWM13
   SysCtrlRegs.PCLKCR2.bit.EPWM14ENCLK = 0;  // ePWM14
   SysCtrlRegs.PCLKCR2.bit.EPWM15ENCLK = 0;  // ePWM15
   SysCtrlRegs.PCLKCR2.bit.EPWM16ENCLK = 0;  // ePWM16
   //------------------------------------------------
...
//  For F28044 - uncomment 1 line only, otherwise leave 4 lines commented
	//GpioCtrlRegs.GPAMCFG.bit.EPWMMODE = 0;		// 1A,1B,2A,2B,...6A,6B, TZ1,TZ2,TZ1,TZ4
	GpioCtrlRegs.GPAMCFG.bit.EPWMMODE = 1;	// 1A,1B,2A,2B,...8A,8B
	//GpioCtrlRegs.GPAMCFG.bit.EPWMMODE = 2;	// 9B,10B,...,16B,9A,10A,...,16A
	//GpioCtrlRegs.GPAMCFG.bit.EPWMMODE = 3;	// 1A,2A,3A,....16A
//--------------------------------------------------------------------------------------
//-----------------------
...
//  GPIO-00 - PIN FUNCTION = --Spare--
	GpioCtrlRegs.GPAMUX1.bit.GPIO0 = 0;		// 0=GPIO,  1=EPWM?? (see PWM config above),  2=Resv,  3=Resv
	GpioCtrlRegs.GPADIR.bit.GPIO0 = 0;		// 1=OUTput,  0=INput 
//	GpioDataRegs.GPACLEAR.bit.GPIO0 = 1;	// uncomment if --> Set Low initially
//	GpioDataRegs.GPASET.bit.GPIO0 = 1;		// uncomment if --> Set High initially
//--------------------------------------------------------------------------------------
//  GPIO-01 - PIN FUNCTION = --Spare--
	GpioCtrlRegs.GPAMUX1.bit.GPIO1 = 0;		// 0=GPIO,  1=EPWM?? (see PWM config above),  2=Resv,  3=Resv
	GpioCtrlRegs.GPADIR.bit.GPIO1 = 0;		// 1=OUTput,  0=INput 
//	GpioDataRegs.GPACLEAR.bit.GPIO1 = 1;	// uncomment if --> Set Low initially
//	GpioDataRegs.GPASET.bit.GPIO1 = 1;		// uncomment if --> Set High initially
//--------------------------------------------------------------------------------------
//  GPIO-02 - PIN FUNCTION = --Spare--
	GpioCtrlRegs.GPAMUX1.bit.GPIO2 = 0;		// 0=GPIO,  1=EPWM?? (see PWM config above),  2=Resv,  3=Resv
	GpioCtrlRegs.GPADIR.bit.GPIO2 = 0;		// 1=OUTput,  0=INput 
//	GpioDataRegs.GPACLEAR.bit.GPIO2 = 1;	// uncomment if --> Set Low initially
//	GpioDataRegs.GPASET.bit.GPIO2 = 1;		// uncomment if --> Set High initially
//--------------------------------------------------------------------------------------
//  GPIO-03 - PIN FUNCTION = --Spare--
	GpioCtrlRegs.GPAMUX1.bit.GPIO3 = 0;		// 0=GPIO,  1=EPWM?? (see PWM config above),  2=Resv,  3=Resv
	GpioCtrlRegs.GPADIR.bit.GPIO3 = 0;		// 1=OUTput,  0=INput 
//	GpioDataRegs.GPACLEAR.bit.GPIO3 = 1;	// uncomment if --> Set Low initially
//	GpioDataRegs.GPASET.bit.GPIO3 = 1;		// uncomment if --> Set High initially
//--------------------------------------------------------------------------------------
//  GPIO-04 - PIN FUNCTION = --Spare--
	GpioCtrlRegs.GPAMUX1.bit.GPIO4 = 0;		// 0=GPIO,  1=EPWM?? (see PWM config above),  2=Resv,  3=Resv
...
//  GPIO-05 - PIN FUNCTION = --Spare--
	GpioCtrlRegs.GPAMUX1.bit.GPIO5 = 0;		// 0=GPIO,  1=EPWM?? (see PWM config above),  2=Resv,  3=Resv
	GpioCtrlRegs.GPADIR.bit.GPIO5 = 0;		// 1=OUTput,  0=INput 
//	GpioDataRegs.GPACLEAR.bit.GPIO5 = 1;	// uncomment if --> Set Low initially
//	GpioDataRegs.GPASET.bit.GPIO5 = 1;		// uncomment if --> Set High initially
//--------------------------------------------------------------------------------------
//  GPIO-06 - PIN FUNCTION = --Spare--
	GpioCtrlRegs.GPAMUX1.bit.GPIO6 = 0;		// 0=GPIO,  1=EPWM?? (see PWM config above),  2=SYNCI,  3=SYNCO
...
//  GPIO-07 - PIN FUNCTION = --Spare--
	GpioCtrlRegs.GPAMUX1.bit.GPIO7 = 0;		// 0=GPIO,  1=EPWM?? (see PWM config above),  2=Resv,  3=Resv
	GpioCtrlRegs.GPADIR.bit.GPIO7 = 0;		// 1=OUTput,  0=INput 
//	GpioDataRegs.GPACLEAR.bit.GPIO7 = 1;	// uncomment if --> Set Low initially
//	GpioDataRegs.GPASET.bit.GPIO7 = 1;		// uncomment if --> Set High initially
//--------------------------------------------------------------------------------------
//  GPIO-08 - PIN FUNCTION = --Spare--
	GpioCtrlRegs.GPAMUX1.bit.GPIO8 = 0;		// 0=GPIO,  1=EPWM?? (see PWM config above),  2=Resv,  3=ADCSOC-A
...
//  GPIO-09 - PIN FUNCTION = --Spare--
	GpioCtrlRegs.GPAMUX1.bit.GPIO9 = 0;		// 0=GPIO,  1=EPWM?? (see PWM config above),  2=Resv,  3=Resv
...
//  GPIO-10 - PIN FUNCTION = --Spare--
	GpioCtrlRegs.GPAMUX1.bit.GPIO10 = 0;	// 0=GPIO,  1=EPWM?? (see PWM config above),  2=Resv,  3=ADCSOC-B
...
//  GPIO-11 - PIN FUNCTION = --Spare--
	GpioCtrlRegs.GPAMUX1.bit.GPIO11 = 0;	// 0=GPIO,  1=EPWM?? (see PWM config above),  2=Resv,  3=Resv
...
//  GPIO-12 - PIN FUNCTION = --Spare--
	GpioCtrlRegs.GPAMUX1.bit.GPIO12 = 0;	// 0=GPIO,  1=EPWM?? (see PWM config above),  2=Resv,  3=Resv
	GpioCtrlRegs.GPADIR.bit.GPIO12 = 0;		// 1=OUTput,  0=INput 
//	GpioDataRegs.GPACLEAR.bit.GPIO12 = 1;	// uncomment if --> Set Low initially
//	GpioDataRegs.GPASET.bit.GPIO12 = 1;		// uncomment if --> Set High initially
//--------------------------------------------------------------------------------------
//  GPIO-13 - PIN FUNCTION = --Spare--
	GpioCtrlRegs.GPAMUX1.bit.GPIO13 = 0;	// 0=GPIO,  1=EPWM?? (see PWM config above),  2=Resv,  3=Resv
...
//  GPIO-14 - PIN FUNCTION = --Spare--
	GpioCtrlRegs.GPAMUX1.bit.GPIO14 = 0;	// 0=GPIO,  1=EPWM?? (see PWM config above),  2=Resv,  3=Resv
...
//  GPIO-15 - PIN FUNCTION = --Spare--
	GpioCtrlRegs.GPAMUX1.bit.GPIO15 = 0;	// 0=GPIO,  1=EPWM?? (see PWM config above),  2=Resv,  3=Resv
...
//  GPIO-21 - PIN FUNCTION = --Spare--
	GpioCtrlRegs.GPAMUX2.bit.GPIO21 = 0;	// 0=GPIO,  1=Resv,  2=Resv,  3=Resv
...
//  GPIO-23 - PIN FUNCTION = --Spare--
	GpioCtrlRegs.GPAMUX2.bit.GPIO23 = 0;	// 0=GPIO,  1=Resv,  2=Resv,  3=Resv
...
//  GPIO-24 - PIN FUNCTION = --Spare--
	GpioCtrlRegs.GPAMUX2.bit.GPIO24 = 0;	// 0=GPIO,  1=Resv,  2=Resv,  3=Resv
...
//  GPIO-25 - PIN FUNCTION = --Spare--
	GpioCtrlRegs.GPAMUX2.bit.GPIO25 = 0;	// 0=GPIO,  1=Resv,  2=Resv,  3=Resv
...
//  GPIO-26 - PIN FUNCTION = --Spare--
	GpioCtrlRegs.GPAMUX2.bit.GPIO26 = 0;	// 0=GPIO,  1=Resv,  2=Resv,  3=Resv
...
//  GPIO-27 - PIN FUNCTION = --Spare--
	GpioCtrlRegs.GPAMUX2.bit.GPIO27 = 0;	// 0=GPIO,  1=Resv,  2=Resv,  3=Resv
...
//  GPIO-30 - PIN FUNCTION = --Spare--
	GpioCtrlRegs.GPAMUX2.bit.GPIO30 = 0;	// 0=GPIO,  1=Resv,  2=Resv,  3=TZ3
...
//--------------------------------------------------------------------------------------
//  GPIO-31 - PIN FUNCTION = LED2 for 280xx Controller Card
	GpioCtrlRegs.GPAMUX2.bit.GPIO31 = 0;	// 0=GPIO,  1=Resv,  2=Resv,  3=TZ4
...
//--------------------------------------------------------------------------------------
//  GPIO-34 - PIN FUNCTION = LED3 for 280xx Controller Card
